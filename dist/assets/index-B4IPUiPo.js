...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qo(e,t,n){return new Zi({name:`SphericalGaussianBlur`,defines:{SAMPLES:Lo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:ts(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $o(){return new Zi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ts(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function es(){return new Zi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ts(),fragmentShader:`
	...
	`}var ns=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Pi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`),r=[];for(let e=0,i=n.length;e<i;e++){let i=n[e].trimStart();if(i.length===0)continue;let a=i.charAt(0);if(a!==`#`){if(a===`v`){let e=i.split(Gl);switch(e[0]){case`v`:t.vertices.push(parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3])),e.length>=7?(Zl.setRGB(parseFloat(e[4]),parseFloat(e[5]),parseFloat(e[6]),Re),t.colors.push(Zl.r,Zl.g,Zl.b)):t.colors.push(void 0,void 0,void 0);break;case`vn`:t.normals.push(parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3]));break;case`vt`:t.uvs.push(parseFloat(e[1]),parseFloat(e[2]))}}else if(a===`f`){let e=i.slice(1).trim().split(Gl),n=[];for(let t=0,r=e.length;t<r;t++){let r=e[t];if(r.length>0){let e=r.split(`/`);n.push(e)}}let r=n[0];for(let e=1,i=n.length-1;e<i;e++){let i=n[e],a=n[e+1];t.addFace(r[0],i[0],a[0],r[1],i[1],a[1],r[2],i[2],a[2])}}else if(a===`l`){let e=i.substring(1).trim().split(` `),n=[],r=[];if(i.indexOf(`/`)===-1)n=e;else for(let t=0,i=e.length;t<i;t++){let i=e[t].split(`/`);i[0]!==``&&n.push(i[0]),i[1]!==``&&r.push(i[1])}t.addLineGeometry(n,r)}else if(a===`p`){let e=i.slice(1).trim().split(` `);t.addPointGeometry(e)}else if((r=Vl.exec(i))!==null){let e=(` `+r[0].slice(1).trim()).slice(1);t.startObject(e)}else if(Ul.test(i))t.object.startMaterial(i.substring(7).trim(),t.materialLibraries);else if(Hl.test(i))t.materialLibraries.push(i.substring(7).trim());else if(Wl.test(i))console.warn(`THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.`);else if(a===`s`){if(r=i.split(` `),r.length>1){let e=r[1].trim().toLowerCase();t.object.smooth=e!==`0`&&e!==`off`}else t.object.smooth=!0;let e=t.object.currentMaterial();e&&(e.smooth=t.object.smooth)}else{if(i===`\0`)continue;console.warn(`THREE.OBJLoader: Unexpected line: "`+i+`"`)}}}t.finalize();let i=new Tn;if(i.materialLibraries=[].concat(t.materialLibraries),t.objects.length!==1||t.objects[0].geometry.vertices.length!==0)for(let e=0,n=t.objects.length;e<n;e++){let n=t.objects[e],r=n.geometry,a=n.materials,o=r.type===`Line`,s=r.type===`Points`,c=!1;if(r.vertices.length===0)continue;let l=new Or;l.setAttribute(`position`,new gr(r.vertices,3)),r.normals.length>0&&l.setAttribute(`normal`,new gr(r.normals,3)),r.colors.length>0&&(c=!0,l.setAttribute(`color`,new gr(r.colors,3))),r.hasUVIndices===!0&&l.setAttribute(`uv`,new gr(r.uvs,2));let u=[];for(let e=0,n=a.length;e<n;e++){let n=a[e],r=n.name+`_`+n.smooth+`_`+c,i=t.materials[r];if(this.materials!==null){if(i=this.materials.create(n.name),o&&i&&!(i instanceof mi)){let e=new mi;Pr.prototype.copy.call(e,i),e.color.copy(i.color),i=e}else if(s&&i&&!(i instanceof Di)){let e=new Di({size:10,sizeAttenuation:!1});Pr.prototype.copy.call(e,i),e.color.copy(i.color),e.map=i.map,i=e}}i===void 0&&(i=o?new mi:s?new Di({size:1,sizeAttenuation:!1}):new ea,i.name=n.name,i.flatShading=!n.smooth,i.vertexColors=c,t.materials[r]=i),u.push(i)}let d;if(u.length>1){for(let e=0,t=a.length;e<t;e++){let t=a[e];l.addGroup(t.groupStart,t.groupCount,e)}d=o?new Ei(l,u):s?new Mi(l,u):new J(l,u)}else d=o?new Ei(l,u[0]):s?new Mi(l,u[0]):new J(l,u[0]);d.name=n.name,i.add(d)}else if(t.vertices.length>0){let e=new Di({size:1,sizeAttenuation:!1}),n=new Or;n.setAttribute(`position`,new gr(t.vertices,3)),t.colors.length>0&&t.colors[0]!==void 0&&(n.setAttribute(`color`,new gr(t.colors,3)),e.vertexColors=!0);let r=new Mi(n,e);i.add(r)}return i}},eu={type:`change`},tu={type:`start`},nu={type:`end`},ru=new zr,iu=new Mr,au=Math.cos(70*Dt.DEG2RAD),ou=new W,su=2*Math.PI,cu={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},lu=1e-6,uu=class extends xo{constructor(n,r=null){super(n,r),this.state=cu.NONE,this.target=new W,this.cursor=new W,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new W,this._lastQuaternion=new Ot,this._lastTargetPosition=new W,this._quat=new Ot().setFromUnitVectors(n.up,new W(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new bo,this._sphericalDelta=new bo,this._scale=1,this._panOffset=new W,this._rotateStart=new U,this._rotateEnd=new U,this._rotateDelta=new U,this._panStart=new U,this._panEnd=new U,this._panDelta=new U,this._dollyStart=new U,this._dollyEnd=new U,this._dollyDelta=new U,this._dollyDirection=new W,this._mouse=new U,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=fu.bind(this),this._onPointerDown=du.bind(this),this._onPointerUp=pu.bind(this),this._onContextMenu=bu.bind(this),this._onMouseWheel=gu.bind(this),this._onKeyDown=_u.bind(this),this._onTouchStart=vu.bind(this),this._onTouchMove=yu.bind(this),this._onMouseDown=mu.bind(this),this._onMouseMove=hu.bind(this),this._interceptControlDown=xu.bind(this),this._interceptControlUp=Su.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.state=cu.NONE,this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents();let e=this.domElement.getRootNode();e.removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),e.removeEventListener(`keyup`,this._interceptControlUp,{capture:!0}),this._controlActive=!1,this._pointers.length=0,this._pointerPositions={},this.domElement.style.touchAction=``,this.domElement.style.cursor=`auto`}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(eu),this.update(),this.state=cu.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;ou.copy(t).sub(this.target),ou.applyQuaternion(this._quat),this._spherical.setFromVector3(ou),this.autoRotate&&this.state===cu.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=su:n>Math.PI&&(n-=su),r<-Math.PI?r+=su:r>Math.PI&&(r-=su),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(ou.setFromSpherical(this._spherical),ou.applyQuaternion(this._quatInverse),t.copy(this.target).add(ou),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=ou.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new W(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new W(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=ou.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(ru.origin.copy(this.object.position),ru.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(ru.direction))<au?this.object.lookAt(this.target):(iu.setFromNormalAndCoplanarPoint(this.object.up,this.target),ru.intersectPlane(iu,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>lu||8*(1-this._lastQuaternion.dot(this.object.quaternion))>lu||this._lastTargetPosition.distanceToSquared(this.target)>lu?(this.dispatchEvent(eu),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?su/60/60*this.autoRotateSpeed:su/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){ou.setFromMatrixColumn(t,0),ou.multiplyScalar(-e),this._panOffset.add(ou)}_panUp(e,t){this.screenSpacePanning===!0?ou.setFromMatrixColumn(t,1):(ou.setFromMatrixColumn(t,0),ou.crossVectors(this.object.up,ou)),ou.multiplyScalar(e),this._panOffset.add(ou)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;ou.copy(r).sub(this.target);let i=ou.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(su*this._rotateDelta.x/t.clientHeight),this._rotateUp(su*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(su*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-su*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(su*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-su*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(su*this._rotateDelta.x/t.clientHeight),this._rotateUp(su*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new U,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function du(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function fu(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function pu(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(nu),this.state=cu.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function mu(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=cu.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=cu.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=cu.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=cu.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=cu.PAN}break;default:this.state=cu.NONE}this.state!==cu.NONE&&this.dispatchEvent(tu)}function hu(e){switch(this.state){case cu.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case cu.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case cu.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function gu(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===cu.NONE&&(e.preventDefault(),this.dispatchEvent(tu),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(nu))}function _u(e){this.enabled!==!1&&this._handleKeyDown(e)}function vu(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=cu.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=cu.TOUCH_PAN;break;default:this.state=cu.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=cu.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=cu.TOUCH_DOLLY_ROTATE;break;default:this.state=cu.NONE}break;default:this.state=cu.NONE}this.state!==cu.NONE&&this.dispatchEvent(tu)}function yu(e){switch(this._trackPointer(e),this.state){case cu.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case cu.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case cu.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case cu.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=cu.NONE}}function bu(e){this.enabled!==!1&&e.preventDefault()}function xu(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function Su(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var Cu=class extends Pn{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new zi;e.deleteAttribute(`uv`);let t=new Y({side:1}),n=new Y,r=new Za(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new J(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new li(e,n,6),o=new wn;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new J(e,wu(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new J(e,wu(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new J(e,wu(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new J(e,wu(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new J(e,wu(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new J(e,wu(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function wu(e){return new ta({color:0,emissive:16777215,emissiveIntensity:e})}var Tu={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Iu.BlurDirectionX=new U(1,0),Iu.BlurDirectionY=new U(0,1);var Lu={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Ru=class extends Eu{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ji.clone(Lu.uniforms),this.material=new Qi({name:Lu.name,uniforms:this.uniforms,vertexShader:Lu.vertexShader,fragmentShader:Lu.fragmentShader}),this._fsQuad=new ku(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},K.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},zu=[{id:1,floor:`LEVEL 01 // LIVING LOUNGE`,room:`living`,name:`Living Lounge`,pos:new W(65,48,220),target:new W(65,32,5),fov:46,hotspots:[{id:`sofa`,pos:new W(65,30,20),name:`Modular Italian Sofa`,category:`CUSTOM FURNITURE`,desc:`Handcrafted high-density cushioning with textured linen-cotton weave and low-slung brushed architectural steel base.`,mat:`Charcoal Textured Linen & Steel`,dim:`310cm x 110cm x 72cm`,origin:`Milan Atelier Bespoke`},{id:`table`,pos:new W(65,18,12),name:`Solid Walnut Coffee Table`,category:`CENTRAL FURNITURE`,desc:`Continuous grain American walnut timber slab with chamfered edge profiling, supported on minimalist darkened iron framework.`,mat:`American Black Walnut & Iron`,dim:`140cm x 75cm x 36cm`,origin:`Hand-Finished Artisan Piece`},{id:`gallery`,pos:new W(48,88,-68),name:`Wall Art Triptych`,category:`CURATED ARTWORK`,desc:`Museum-grade fine art giclée canvas prints presented in bespoke ebonized oak floating shadowbox frames.`,mat:`Giclée on Archival Canvas`,dim:`Three 70cm x 100cm Frames`,origin:`Contemporary Studio Series`}]},{id:2,floor:`LEVEL 01 // CULINARY & DINING`,room:`living`,name:`Dining Room Suite`,pos:new W(145,36,140),target:new W(55,20,82),fov:48,hotspots:[{id:`dining_table`,pos:new W(61.5,20,85),name:`Solid Walnut Dining Table`,category:`DINING ARCHITECTURE`,desc:`Substantial American walnut slab dining table with hand-chamfered edge detailing, recessed steel framework, and natural matte oiled finish.`,mat:`Smoked American Walnut & Steel`,dim:`240cm x 95cm x 76cm`,origin:`Artisan Workshop Craft`},{id:`dining_teapot`,pos:new W(39.6,28,80),name:`Artisan Ceramic Stoneware`,category:`CERAMIC SCULPTURE`,desc:`Hand-thrown architectural ceramic stoneware teapot and tableware with volcanic matte black textured glaze.`,mat:`High-Fired Volcanic Glaze Stoneware`,dim:`Sculptural Tableware Set`,origin:`Kyoto Studio Bespoke`},{id:`dining_benches`,pos:new W(142,15,84),name:`Low-Slung Dining Benches`,category:`DINING SEATING`,desc:`Minimalist low-profile timber dining benches with tailored charcoal linen upholstery and brushed steel support legs.`,mat:`Charcoal Linen & Smoked Oak`,dim:`180cm x 45cm x 45cm`,origin:`Nordic Minimalist Line`}]},{id:3,floor:`LEVEL 01 // ARCHITECTURAL PANORAMA`,room:`living`,name:`Grand Living & Dining Panorama`,pos:new W(200,48,195),target:new W(40,30,10),fov:54,hotspots:[{id:`double_glazing`,pos:new W(-68,65,120),name:`Double-Height Glazing Facade`,category:`STRUCTURAL ENVELOPE`,desc:`Floor-to-ceiling architectural thermal curtain wall with low-iron acoustic glazing, flooding both living and culinary suites with natural daylight.`,mat:`Low-Iron Acoustic Glass & Aluminum`,dim:`Full Double-Height Curtain Wall`,origin:`Architectural Glazing Studio`},{id:`living_overview`,pos:new W(60,20,30),name:`Continuous Oak Floorplan`,category:`INTERIOR ARCHITECTURE`,desc:`Seamless wide-plank French oak hardwood flooring unifying the open-concept ground pavilion with subtle clearcoat satin luster.`,mat:`Natural French Oak Wide Planks`,dim:`Ground Pavilion Coverage`,origin:`Bespoke Architectural Flooring`}]},{id:4,floor:`LEVEL 02 // MASTER SUITE`,room:`bedroom`,name:`Master Bed Focal Suite`,pos:new W(-35,42,235),target:new W(55,28,155),fov:48,hotspots:[{id:`bed`,pos:new W(48,22,154),name:`King Master Platform Bed`,category:`BEDROOM SUITE`,desc:`Low-profile solid timber platform bed with tailored charcoal linen bedding, integrated floating walnut side tables, and ergonomic support mattress.`,mat:`Smoked Walnut & Woven Slate Linen`,dim:`210cm x 200cm x 45cm`,origin:`Nordic Architectural Studio`},{id:`pendant`,pos:new W(115,52,131),name:`Translucent Opal Glass Pendants`,category:`AMBIENT LIGHTING`,desc:`Hand-blown satin opal glass diffusers emitting a warm 2700K ambient illumination with brushed champagne brass suspension fittings.`,mat:`Blown Opal Glass & Brushed Brass`,dim:`Dual 25cm Spherical Fixtures`,origin:`Scandinavian Lighting Lab`}]},{id:5,floor:`LEVEL 02 // STUDIO & MEDIA`,room:`bedroom`,name:`Executive Workstation & Media`,pos:new W(15,56,85),target:new W(95,38,12),fov:52,hotspots:[{id:`desk`,pos:new W(100,38,10),name:`Executive Architectural Workstation`,category:`STUDIO FURNITURE`,desc:`Floating solid timber desktop with concealed cable raceway, soft-close stationery drawers, and sculpted ergonomic studio task chair.`,mat:`Solid Natural Oak & Graphite Frame`,dim:`160cm x 70cm x 75cm`,origin:`Custom Joinery Workshop`},{id:`media`,pos:new W(-93,50,158),name:`Media Lounge Display Console`,category:`ENTERTAINMENT SUITE`,desc:`Acoustically treated wood panel feature wall with flush-mounted ultra-slim display and floating minimalist media credenza.`,mat:`Acoustic Fluted Panels & Matt Black Trim`,dim:`220cm x 40cm x 65cm`,origin:`Hi-Fi Studio Integration`}]},{id:6,floor:`LEVEL 02 // PRIVATE SALON`,room:`bedroom`,name:`Private Mezzanine Lounge`,pos:new W(28,36,-195),target:new W(-18,24,-315),fov:52,hotspots:[{id:`lounge_sofa`,pos:new W(-10,18,-365),name:`Modular Sectional Sofa`,category:`BESPOKE SEATING`,desc:`Deep-seat L-shaped sectional sofa with charcoal textured woven fabric, ergonomic multi-density foam cushions, and low-profile smoked timber base.`,mat:`Charcoal Heather Weave & Smoked Timber`,dim:`320cm x 220cm x 75cm`,origin:`Milan Atelier Bespoke`},{id:`lounge_chair`,pos:new W(63,22,-254),name:`Sculptural Wire Accent Chair`,category:`DESIGNER SEATING`,desc:`Iconic curved architectural steel frame with upholstered ergonomic leather seat and tactile curved backrest contour.`,mat:`Graphite Tubular Steel & Saddle Leather`,dim:`68cm x 65cm x 76cm`,origin:`Contemporary Studio Icon`},{id:`lounge_table`,pos:new W(66,12,-325),name:`Artisan Low Coffee Table`,category:`LIVING FURNITURE`,desc:`Minimalist low-profile coffee table featuring solid natural oak slab surface with chamfered edge and brushed steel cylindrical supports.`,mat:`Solid Natural Oak & Brushed Steel`,dim:`120cm x 70cm x 36cm`,origin:`Hand-Finished Artisan Joinery`},{id:`lounge_gallery`,pos:new W(-104,90,-284),name:`Curated Gallery Triptych`,category:`FINE ART COLLECTION`,desc:`Museum-grade archival giclée canvas series in slim ebonized timber frames, illuminated by soft architectural wash lighting.`,mat:`Archival Canvas in Shadowbox Frames`,dim:`Three 75cm x 75cm Frames`,origin:`Private Gallery Curation`}]}],Bu=`living`,Vu=!1,Hu=!1,Uu=0,Q,Wu,Gu,Ku,qu,Ju,$={},Yu={living:null,bedroom:null},Xu={living:{},bedroom:{}},Zu=new W,Qu=new W,$u=46,ed=new W,td=new W,nd=46,rd=0,id=document.getElementById(`webgl-canvas`),ad=document.getElementById(`loader`),od=document.getElementById(`loader-bar`),sd=document.getElementById(`loader-status`),cd=document.getElementById(`hud-floor-badge`),ld=document.getElementById(`room-transition-overlay`),ud=!1,dd=null,fd=0,pd=0,md=0,hd=0,gd=0,_d=0,vd=0,yd=0,bd=!1,xd,Sd=document.getElementById(`btn-mode`),Cd=document.getElementById(`mode-text`),wd=document.getElementById(`btn-reset`),Td=document.getElementById(`btn-toggle-ui`),Ed=document.getElementById(`btn-customizer`),Dd=document.getElementById(`btn-autotour`),Od=document.getElementById(`autotour-text`),kd=document.querySelectorAll(`.screen-nav-item`),Ad=document.getElementById(`nav-indicator-fill`),jd=document.querySelectorAll(`.journey-pill`),Md=document.getElementById(`hotspots-layer`),Nd=document.getElementById(`hotspot-modal`),Pd=document.getElementById(`btn-close-hotspot`),Fd=document.getElementById(`modal-category`),Id=document.getElementById(`modal-title`),Ld=document.getElementById(`modal-desc`),Rd=document.getElementById(`modal-mat`),zd=document.getElementById(`modal-dim`),Bd=document.getElementById(`modal-origin`),Vd=document.getElementById(`customizer-drawer`),Hd=document.getElementById(`btn-close-customizer`),Ud=document.getElementById(`exposure-slider`),Wd=document.getElementById(`exposure-val`),Gd=document.getElementById(`bloom-slider`),Kd=document.getElementById(`bloom-val`),qd={};function Jd(){Q=new Pn,Q.background=null,Q.fog=new Nn(11586792,25e-5);let e=window.innerWidth/window.innerHeight,t=zu[0];Zu.copy(t.pos),Qu.copy(t.target),$u=t.fov,ed.copy(Zu),td.copy(Qu),nd=$u,Wu=new qa($u,e,1,2500),Wu.position.copy(Zu),Wu.lookAt(Qu),Gu=new Bl({canvas:id,antialias:!0,powerPreference:`high-performance`}),Gu.setSize(window.innerWidth,window.innerHeight),Gu.setPixelRatio(Math.min(window.devicePixelRatio,2)),Gu.shadowMap.enabled=!0,Gu.shadowMap.type=2,Gu.toneMapping=4,Gu.toneMappingExposure=.88;let n=new qo(Gu);n.compileEquirectangularShader();let r=new Cu;Q.environment=n.fromScene(r).texture,r.dispose(),qu=new Nu(Gu);let i=new Pu(Q,Wu);qu.addPass(i),Ju=new Iu(new U(window.innerWidth,window.innerHeight),.22,.35,.92),qu.addPass(Ju);let a=new Ru;qu.addPass(a),Ku=new uu(Wu,id),Ku.enableDamping=!0,Ku.dampingFactor=.05,Ku.target.copy(Qu),Ku.enabled=!1,Ku.maxPolarAngle=Math.PI/2+.05,Ku.minDistance=15,Ku.maxDistance=600,Zd(),Yd(),Qd(),ff(),mf()}function Yd(){let e=new eo(16773598,2.1);e.position.set(-220,170,130),e.target.position.set(65,20,30),e.castShadow=!0,e.shadow.mapSize.width=2048,e.shadow.mapSize.height=2048,e.shadow.camera.near=40,e.shadow.camera.far=750,e.shadow.camera.left=-220,e.shadow.camera.right=220,e.shadow.camera.top=220,e.shadow.camera.bottom=-220,e.shadow.bias=-1e-4,e.shadow.normalBias=.035,e.shadow.radius=2.2,Q.add(e),Q.add(e.target),$.sunLight=e;let t=new eo(9221350,.7);t.position.set(-160,90,140),t.target.position.set(80,45,60),Q.add(t),Q.add(t.target),$.windowFill=t;let n=new eo(13935978,.75);n.position.set(65,-30,60),n.target.position.set(65,120,60),Q.add(n),Q.add(n.target),$.floorBounce=n;let r=new Fa(9480392,2759698,.55);r.position.set(0,250,0),Q.add(r),$.hemiLight=r;let i=new Za(16770754,.75,450,1.4);i.position.set(60,150,50),Q.add(i),$.ceilingLight=i;let a=new Za(16772829,1.4,260,1.4);a.position.set(61.5,90,85),Q.add(a),$.diningLight=a;let o=new Za(16750899,2.4,220,1.5);o.position.set(115,52,131),Q.add(o),$.bedLamp=o;let s=new Za(16768947,1,260,1.4);s.position.set(230,80,-30),Q.add(s),$.stairLight=s;let c=new Za(16772829,1.8,380,1.2);c.position.set(10,110,-270),Q.add(c),$.loungeLight=c;let l=new Ya(16774368,1.5,260,Math.PI/4,.4,1.2);l.position.set(-20,100,-280),l.target.position.set(-105,88,-284),Q.add(l),Q.add(l.target),$.loungeArtSpot=l,xd=new J(new Hi(950,48,32),new Br({map:qd.skyPanorama?qd.skyPanorama.daylight:null,side:1,depthWrite:!1})),xd.position.set(65,40,60),Q.add(xd),Xd(`daylight`)}function Xd(e){document.querySelectorAll(`.atmos-btn`).forEach(t=>{t.classList.toggle(`active`,t.getAttribute(`data-atmos`)===e)}),xd&&qd.skyPanorama&&qd.skyPanorama[e]&&(xd.material.map=qd.skyPanorama[e],xd.material.needsUpdate=!0),e===`daylight`?($.sunLight.color.setHex(16773598),$.sunLight.intensity=2.1,$.sunLight.position.set(-220,170,130),$.windowFill.color.setHex(9221350),$.windowFill.intensity=.7,$.floorBounce.color.setHex(13935978),$.floorBounce.intensity=.75,$.hemiLight.color.setHex(9480392),$.hemiLight.groundColor.setHex(2759698),$.hemiLight.intensity=.55,$.ceilingLight.intensity=.75,$.diningLight.intensity=1.4,$.bedLamp.intensity=1.5,$.stairLight.intensity=.9,$.loungeLight.intensity=1.6,$.loungeLight.color.setHex(16772829),$.loungeArtSpot.intensity=1.4,Q.fog.color.setHex(11586792),Q.fog.density=22e-5,Q.background=null,Gu.toneMappingExposure=1.05,Ju.strength=.22):e===`sunset`?($.sunLight.color.setHex(16742178),$.sunLight.intensity=2.6,$.sunLight.position.set(-260,80,70),$.windowFill.color.setHex(13395490),$.windowFill.intensity=.95,$.floorBounce.color.setHex(11752734),$.floorBounce.intensity=.95,$.hemiLight.color.setHex(11757107),$.hemiLight.groundColor.setHex(1706499),$.hemiLight.intensity=.48,$.ceilingLight.intensity=.85,$.diningLight.intensity=1.8,$.bedLamp.intensity=2.2,$.stairLight.intensity=1.2,$.loungeLight.intensity=2.2,$.loungeLight.color.setHex(16768952),$.loungeArtSpot.intensity=1.8,Q.fog.color.setHex(5907224),Q.fog.density=28e-5,Q.background=null,Gu.toneMappingExposure=1.08,Ju.strength=.32):e===`night`&&($.sunLight.color.setHex(2242649),$.sunLight.intensity=.35,$.sunLight.position.set(-200,140,90),$.windowFill.color.setHex(1121840),$.windowFill.intensity=.25,$.floorBounce.color.setHex(3350548),$.floorBounce.intensity=.2,$.hemiLight.color.setHex(1251878),$.hemiLight.groundColor.setHex(525829),$.hemiLight.intensity=.35,$.ceilingLight.color.setHex(16755268),$.ceilingLight.intensity=1.9,$.diningLight.color.setHex(16758886),$.diningLight.intensity=2.4,$.bedLamp.color.setHex(16747546),$.bedLamp.intensity=3.6,$.stairLight.color.setHex(16755268),$.stairLight.intensity=2.2,$.loungeLight.intensity=2.8,$.loungeLight.color.setHex(16763018),$.loungeArtSpot.intensity=2.2,Q.fog.color.setHex(659485),Q.fog.density=32e-5,Q.background=null,Gu.toneMappingExposure=.95,Ju.strength=.28)}function Zd(){let e=document.createElement(`canvas`);e.width=1024,e.height=1024;let t=e.getContext(`2d`);t.fillStyle=`#d0d4dc`,t.fillRect(0,0,1024,1024),t.strokeStyle=`rgba(70, 75, 88, 0.4)`,t.lineWidth=3.5,t.beginPath(),t.moveTo(0,200),t.bezierCurveTo(300,150,600,450,1024,380),t.stroke();let r=new Fi(e);r.wrapS=n,r.wrapT=n,r.repeat.set(4,4),qd.marble=r;let i=document.createElement(`canvas`);i.width=1024,i.height=1024;let a=i.getContext(`2d`);a.fillStyle=`#1c120c`,a.fillRect(0,0,1024,1024);for(let e=0;e<1024;e+=12)a.fillStyle=e%24==0?`rgba(10, 5, 2, 0.6)`:`rgba(35, 20, 12, 0.4)`,a.fillRect(0,e,1024,6);let o=new Fi(i);o.wrapS=n,o.wrapT=n,o.repeat.set(3,3),qd.walnut=o;let s={};[`daylight`,`sunset`,`night`].forEach(e=>{let t=2048,n=1024,r=document.createElement(`canvas`);r.width=t,r.height=n;let i=r.getContext(`2d`),a=n*.52,o=i.createLinearGradient(0,0,0,592.48);if(e===`daylight`?(o.addColorStop(0,`#155bb5`),o.addColorStop(.35,`#3e8fe0`),o.addColorStop(.7,`#86c2f5`),o.addColorStop(.92,`#cce6fa`),o.addColorStop(1,`#fff4de`)):e===`sunset`?(o.addColorStop(0,`#1b092b`),o.addColorStop(.28,`#46144e`),o.addColorStop(.55,`#8c2445`),o.addColorStop(.78,`#d4491d`),o.addColorStop(.94,`#f59331`),o.addColorStop(1,`#ffcf6b`)):(o.addColorStop(0,`#040711`),o.addColorStop(.35,`#081122`),o.addColorStop(.7,`#0f1f3d`),o.addColorStop(.92,`#182b4f`),o.addColorStop(1,`#263b61`)),i.fillStyle=o,i.fillRect(0,0,t,612.48),e===`night`){i.fillStyle=`#ffffff`;for(let e=0;e<700;e++){let n=(Math.sin(e*997)*.5+.5)*t,r=(Math.cos(e*613)*.5+.5)*(a*.85),o=e%7==0?1.6:e%3==0?1:.6;i.globalAlpha=.35+(Math.sin(e*43)*.5+.5)*.65,i.beginPath(),i.arc(n,r,o,0,Math.PI*2),i.fill()}i.globalAlpha=1;let e=t*.28,r=n*.22,o=i.createRadialGradient(e,r,8,e,r,90);o.addColorStop(0,`rgba(235, 245, 255, 0.9)`),o.addColorStop(.2,`rgba(180, 210, 255, 0.4)`),o.addColorStop(1,`rgba(100, 160, 255, 0)`),i.fillStyle=o,i.beginPath(),i.arc(e,r,90,0,Math.PI*2),i.fill(),i.fillStyle=`#ffffff`,i.beginPath(),i.arc(e,r,14,0,Math.PI*2),i.fill()}if(e===`daylight`){let e=t*.26,n=a*.45,r=i.createRadialGradient(e,n,12,e,n,320);r.addColorStop(0,`rgba(255, 255, 245, 1.0)`),r.addColorStop(.12,`rgba(255, 248, 210, 0.85)`),r.addColorStop(.4,`rgba(255, 235, 170, 0.35)`),r.addColorStop(1,`rgba(255, 220, 140, 0.0)`),i.fillStyle=r,i.beginPath(),i.arc(e,n,320,0,Math.PI*2),i.fill()}else if(e===`sunset`){let e=t*.26,n=a*.82,r=i.createRadialGradient(e,n,16,e,n,420);r.addColorStop(0,`rgba(255, 250, 220, 1.0)`),r.addColorStop(.15,`rgba(255, 180, 70, 0.9)`),r.addColorStop(.45,`rgba(235, 80, 20, 0.45)`),r.addColorStop(1,`rgba(160, 30, 20, 0.0)`),i.fillStyle=r,i.beginPath(),i.arc(e,n,420,0,Math.PI*2),i.fill()}if(e!==`night`){i.fillStyle=e===`daylight`?`rgba(255, 255, 255, 0.28)`:`rgba(255, 190, 140, 0.32)`;for(let e=0;e<16;e++){let n=e/16*t+Math.sin(e*19)*80,r=a*.35+Math.cos(e*31)*70,o=160+Math.sin(e*7)*70,s=38+Math.cos(e*11)*16;i.beginPath(),i.ellipse(n,r,o,s,0,0,Math.PI*2),i.fill()}}i.fillStyle=e===`daylight`?`#688ca8`:e===`sunset`?`#5a223c`:`#0c1626`,i.beginPath(),i.moveTo(0,552.48);for(let e=0;e<=t;e+=40){let t=487.48+Math.sin(e*.006)*35+Math.sin(e*.015)*18;i.lineTo(e,t)}i.lineTo(t,582.48),i.lineTo(0,582.48),i.closePath(),i.fill(),i.fillStyle=e===`daylight`?`#446e58`:e===`sunset`?`#3d1627`:`#070f1a`,i.beginPath(),i.moveTo(0,562.48);for(let e=0;e<=t;e+=30){let t=512.48+Math.sin(e*.011+2)*22+Math.cos(e*.024)*12;i.lineTo(e,t)}i.lineTo(t,582.48),i.lineTo(0,582.48),i.closePath(),i.fill(),i.fillStyle=e===`daylight`?`#254a2a`:e===`sunset`?`#230e16`:`#040810`,i.beginPath(),i.moveTo(0,572.48);for(let e=0;e<=t;e+=12){let t=527.48+Math.sin(e*.05)*7+Math.sin(e*.02)*9;i.lineTo(e,t)}if(i.lineTo(t,582.48),i.lineTo(0,582.48),i.closePath(),i.fill(),e===`night`){i.fillStyle=`#ffdf88`;for(let e=0;e<180;e++){let n=e/180*t+Math.sin(e*37)*15,r=528.48+Math.cos(e*53)*6;i.globalAlpha=.4+(Math.sin(e*71)*.5+.5)*.6,i.fillRect(n,r,2.2,2.2)}i.globalAlpha=1}let c=i.createLinearGradient(0,a,0,n);e===`daylight`?(c.addColorStop(0,`#2e3a2b`),c.addColorStop(.3,`#1d261b`),c.addColorStop(1,`#0e140d`)):e===`sunset`?(c.addColorStop(0,`#2a1210`),c.addColorStop(.4,`#190a09`),c.addColorStop(1,`#0d0505`)):(c.addColorStop(0,`#0a0f16`),c.addColorStop(1,`#040609`)),i.fillStyle=c,i.fillRect(0,562.48,t,491.52);let l=new Fi(r);l.colorSpace=Re,s[e]=l}),qd.skyPanorama=s}function Qd(){let e=new Ta,t=new Na(e);e.onProgress=(e,t,n)=>{let r=Math.round(t/n*100);od.style.width=`${r}%`,sd.textContent=`Loading architectural suites: ${r}%`},e.onLoad=()=>{sd.textContent=`Calibrating high-contrast architectural lighting...`,setTimeout(()=>{ad.classList.add(`hidden`),ef()},400)};function r(e,r=1,i=1){let a=t.load(e);return a.colorSpace=Re,(r!==1||i!==1)&&(a.wrapS=n,a.wrapT=n,a.repeat.set(r,i)),a}let i=r(`./textures/floor_wood.jpg`);qd.floorOak=i;let a=r(`./textures/table_wood.jpg`),o=r(`./textures/sofa_wood.jpg`),s=r(`./textures/sofa_wood_right.jpg`),c=r(`./textures/sofa_wood_base.jpg`),l=r(`./textures/wall.jpg`),u=r(`./textures/painting_1.jpg`),d=r(`./textures/painting_2.jpg`),f=r(`./textures/painting_3.jpg`),p={floor:new $i({map:i,roughness:.26,metalness:.02,clearcoat:.38,clearcoatRoughness:.22,envMapIntensity:.85}),tableWood:new Y({map:a,roughness:.32,metalness:.03,envMapIntensity:.65}),tableFrame:new Y({color:1184791,roughness:.18,metalness:.92,envMapIntensity:.9}),vase:new $i({color:1316120,roughness:.06,metalness:.04,clearcoat:.95,clearcoatRoughness:.05,envMapIntensity:1}),painting1:new Y({map:u,roughness:.42}),painting2:new Y({map:d,roughness:.42}),painting3:new Y({map:f,roughness:.42}),cushion:new Y({color:3552306,roughness:.86,metalness:.01,envMapIntensity:.2}),sofaWoodBase:new Y({map:c,roughness:.36}),sofaWoodRight:new Y({map:s,roughness:.36}),sofaWoodPuff:new Y({map:o,roughness:.36}),chromeLegs:new Y({color:14211288,roughness:.06,metalness:.96,envMapIntensity:1.1}),backWall:new Y({map:l,color:7236454,roughness:.82,metalness:.02,envMapIntensity:.25}),ceiling:new Y({color:2237481,roughness:.92,metalness:0}),stairs:new Y({color:4080200,roughness:.4,metalness:.3}),stairCables:new Y({color:8554642,roughness:.2,metalness:.92,envMapIntensity:.9}),windowFrame:new Y({color:790032,roughness:.3,metalness:.88}),windowGlass:new $i({color:16777215,transparent:!0,opacity:.16,roughness:.03,transmission:.92,ior:1.52,reflectivity:.6})};Xu.living=p;let m=r(`./textures/bedroom/bed_texture.jpg`),h=r(`./textures/bedroom/beds_box_texture.jpg`),g=r(`./textures/bedroom/wood_wall.jpg`),_=r(`./textures/bedroom/scenre.jpg`),v=r(`./textures/bedroom/alhmari.jpg`),y=r(`./textures/bedroom/study_table_wood.jpg`),b=r(`./textures/bedroom/door.jpg`),x=r(`./textures/bedroom/toilet_tile.jpg`),S=r(`./textures/bedroom/toilet_tile_bump.jpg`),C=r(`./textures/bedroom/toilet_wood_stor_1.jpg`),w=r(`./textures/bedroom/toilet_wood_stor_2.jpg`),T=r(`./textures/bedroom/tv_desktop.jpg`),E=r(`./textures/bedroom/tvs_back_wall.jpg`),D=r(`./textures/bedroom/sopha_wood_uv_texture.jpg`),O=r(`./textures/bedroom/double_sopha_wood_right_uv_texture_.jpg`),k=r(`./textures/bedroom/double_sopha_wood_base_bace_uv_.jpg`),A={floor:new $i({map:i,roughness:.26,metalness:.02,clearcoat:.38,clearcoatRoughness:.22,envMapIntensity:.85}),bedFrame:new Y({map:m,roughness:.42,metalness:.02}),bedDuvet:new Y({color:3027256,roughness:.84,metalness:.02}),pillow:new Y({color:5132892,roughness:.78,metalness:.02}),bedBox:new Y({map:h,roughness:.42,metalness:.04}),woodWall:new Y({map:g,roughness:.38,metalness:.03,envMapIntensity:.5}),scenre:new Y({map:_,roughness:.45}),alhmari:new Y({map:v,roughness:.3,metalness:.12,envMapIntensity:.6}),studyTable:new Y({map:y,roughness:.34,metalness:.04,envMapIntensity:.55}),door:new Y({map:b,roughness:.42}),toiletTile:new $i({map:x,bumpMap:S,bumpScale:.04,roughness:.18,clearcoat:.65,clearcoatRoughness:.12,envMapIntensity:.8}),toiletWood1:new Y({map:C,roughness:.42}),toiletWood2:new Y({map:w,roughness:.42}),tvDesktop:new Y({map:T,roughness:.22,emissive:new q(925235),emissiveIntensity:.9}),tvBackWall:new Y({map:E,roughness:.6}),tvPlastic:new Y({color:790033,roughness:.25,metalness:.75}),lamp:new $i({color:16769725,emissive:new q(16747546),emissiveIntensity:2.2,roughness:.18,transmission:.5,ior:1.45}),ceramicBowl:new $i({color:1316120,roughness:.08,clearcoat:.95,clearcoatRoughness:.05,envMapIntensity:1}),chrome:new Y({color:14211288,roughness:.06,metalness:.96,envMapIntensity:1.1}),sophaWood:new Y({map:D,roughness:.38}),doubleSophaRight:new Y({map:O,roughness:.38}),doubleSophaBase:new Y({map:k,roughness:.38}),cushion:new Y({color:3552306,roughness:.85,metalness:.02}),wallMat:new Y({color:3420463,roughness:.85,metalness:0,envMapIntensity:.25}),painting1:new Y({map:u,roughness:.42}),painting2:new Y({map:d,roughness:.42}),painting3:new Y({map:f,roughness:.42})};Xu.bedroom=A;function j(e){let t=new Tn;t.name=`architectural_enclosure`;let n=new J(new Vi(140,440),e.floor);n.rotation.x=-Math.PI/2,n.position.set(350,.4,135),n.receiveShadow=!0,t.add(n);let r=new J(new Vi(440,245),e.backWall);r.rotation.y=-Math.PI/2,r.position.set(408,122,135),r.receiveShadow=!0,t.add(r);let i=new J(new Vi(485,245),e.backWall);i.rotation.y=Math.PI,i.position.set(168,122,355),i.receiveShadow=!0,t.add(i);let a=new J(new Vi(485,440),e.ceiling);a.rotation.x=Math.PI/2,a.position.set(168,244,135),a.receiveShadow=!0,t.add(a);let o=new J(new Vi(320,440),new Y({color:4012082,roughness:.65,metalness:.05}));o.rotation.x=-Math.PI/2,o.position.set(-225,.2,135),o.receiveShadow=!0,t.add(o);let s=new J(new Vi(440,24),new $i({color:16777215,transparent:!0,opacity:.35,roughness:.05,transmission:.9,ior:1.5}));s.rotation.y=Math.PI/2,s.position.set(-382,12,135),t.add(s);let c=new J(new zi(4,2,440),new Y({color:1842980,roughness:.25,metalness:.92}));c.position.set(-382,24,135),t.add(c);let l=new Y({color:2237738,roughness:.85}),u=new Y({color:4027450,roughness:.45,envMapIntensity:.6});[35,135,235].forEach(e=>{let n=new J(new zi(22,16,80),l);n.position.set(-92,8,e),n.castShadow=!0,n.receiveShadow=!0,t.add(n);for(let n=-28;n<=28;n+=14){let r=34+Math.sin(n*3)*10,i=new J(new Bi(1.2,2,r,6),u);i.position.set(-92+Math.sin(n)*2,16+r/2,e+n),i.rotation.z=Math.sin(n*5)*.08,i.castShadow=!0,t.add(i)}});let d=new Za(16772829,1.2,320,1.4);return d.position.set(-110,30,135),t.add(d),t}let ee=new $l(e);ee.load(`./models/house_interior.obj`,e=>{Yu.living=e,e.add(j(p)),e.traverse(e=>{if(e.isMesh){e.castShadow=!0,e.receiveShadow=!0;let t=e.name;e.material=t===`Plane001`?p.floor:t===`Plane003`?p.backWall:t===`Plane002`||t===`Plane004`||t===`Box001`||t===`Box002`?p.ceiling:t===`Box038`?p.painting1:t===`Box043`?p.painting2:t===`Box044`?p.painting3:t===`Box032`?p.tableWood:t===`Box033`?p.tableFrame:t===`Teapot001`?p.vase:t===`Box028`||t===`Box045`?p.sofaWoodPuff:t===`Box027`||t===`Box029`?p.cushion:t===`Box017`?p.sofaWoodBase:t===`Box020`||t===`Box022`||t===`Box046`?p.sofaWoodRight:t===`Box019`||t===`Box021`||t===`Box023`||t===`Box024`||t===`Box025`||t===`Box026`?p.cushion:t.startsWith(`Cylinder05`)||t.startsWith(`Cylinder06`)?p.chromeLegs:t.startsWith(`Box00`)||t.startsWith(`Box01`)||t.startsWith(`Cylinder00`)||t.startsWith(`Cylinder010`)||t.startsWith(`Cylinder011`)?p.stairs:t.startsWith(`Cylinder01`)||t.startsWith(`Cylinder02`)||t.startsWith(`Cylinder03`)?p.stairCables:t===`Box037`?p.windowFrame:t===`Plane005`?p.windowGlass:p.stairs}}),Bu===`living`&&Q.add(e)}),ee.load(`./models/bedroom_interior.obj`,e=>{Yu.bedroom=e;let t=new J(new Vi(240,160),A.wallMat);t.position.set(5,75,-386),t.receiveShadow=!0,e.add(t);let n=new J(new Vi(350,170),A.wallMat);n.rotation.y=-Math.PI/2,n.position.set(125,80,-250),n.receiveShadow=!0,e.add(n);let r=new J(new Vi(260,350),A.wallMat);r.rotation.x=Math.PI/2,r.position.set(5,160,-250),r.receiveShadow=!0,e.add(r),e.traverse(e=>{if(e.isMesh){e.castShadow=!0,e.receiveShadow=!0;let t=e.name;e.material=t===`Box002`?A.bedFrame:t===`Box038`?A.bedDuvet:t===`Box039`||t===`Box040`?A.pillow:t===`Line001`?A.ceramicBowl:t===`Object004`?A.bedBox:t===`Object005`?A.woodWall:t===`Box035`?A.scenre:t===`Box018`||t===`Box061`?A.alhmari:t===`Box003`?A.studyTable:t===`Object006`?A.door:t===`Object007`?A.floor:t===`Object002`?A.toiletTile:t===`Object003`?A.toiletWood1:t===`Box026`?A.toiletWood2:t===`Box034`?A.tvDesktop:t===`Box029`?A.tvBackWall:t===`Box032`?A.tvPlastic:t===`Box063`?A.painting1:t===`Box064`?A.painting2:t===`Box065`?A.painting3:t===`Box044`||t===`Cylinder060`?A.studyTable:t===`Cylinder059`||t===`Cylinder061`||t===`Cylinder062`?A.chrome:t===`Cylinder090`||t===`Cylinder097`?A.cushion:t===`Cylinder085`||t===`Cylinder089`||t===`Cylinder091`||t===`Cylinder092`||t===`Cylinder093`||t===`Cylinder094`||t===`Cylinder095`||t===`Cylinder096`||t===`Cylinder098`||t===`Box068`||t===`Box069`?A.chrome:t.startsWith(`Cylinder001`)||t.startsWith(`Cylinder002`)||t.startsWith(`Cylinder003`)||t===`Sphere001`?A.lamp:t.startsWith(`Cylinder05`)||t.startsWith(`Cylinder06`)||t.startsWith(`Cylinder07`)||t.startsWith(`Cylinder004`)||t.startsWith(`Cylinder018`)||t.startsWith(`Cylinder019`)||t===`Sphere002`?A.chrome:t===`Box045`||t===`Box048`?A.sophaWood:t===`Box020`||t===`Box022`||t===`Box046`||t===`Box054`||t===`Box056`||t===`Box058`?A.doubleSophaRight:t===`Box017`||t===`Box057`?A.doubleSophaBase:t.startsWith(`Box043`)||t.startsWith(`Box062`)||t.startsWith(`Box066`)||t.startsWith(`Box067`)||t.startsWith(`Cylinder08`)||t.startsWith(`Cylinder09`)?A.cushion:A.wallMat}}),Bu===`bedroom`&&Q.add(e)})}function $d(e){let t=zu.length-1,n=e*t,r=Math.min(Math.floor(n),t-1),i=n-r,a=.5-.5*Math.cos(i*Math.PI),o=zu[r],s=zu[r+1];return{pos:new W().lerpVectors(o.pos,s.pos,a),target:new W().lerpVectors(o.target,s.target,a),fov:Dt.lerp(o.fov,s.fov,a),currentStage:o,nextStage:s}}function ef(){if(Vu||Hu)return;let e=document.documentElement.scrollHeight-window.innerHeight,t=window.scrollY;rd=e>0?Math.min(Math.max(t/e,0),1):0;let n=$d(rd);ed.copy(n.pos),td.copy(n.target),nd=n.fov,Ad&&(Ad.style.height=`${rd*100}%`);let r=Math.min(Math.floor(rd*6)+1,6),i=rd<.5?`living`:`bedroom`;if(i!==Bu&&(Bu=i,Yu.living&&Yu.bedroom&&(Bu===`living`?(Q.remove(Yu.bedroom),Q.add(Yu.living),$.sunLight.target.position.set(65,20,30)):(Q.remove(Yu.living),Q.add(Yu.bedroom),$.sunLight.target.position.set(40,20,100)))),ld){if(rd>=.43&&rd<=.57){let e=Math.abs(rd-.5)/.07,t=Math.sin((1-e)*(Math.PI/2));ld.style.opacity=Math.max(0,Math.min(1,t)).toFixed(3)}else ld.style.opacity=`0`}cd.textContent=rd<.5?`LEVEL 01 // GROUND`:`LEVEL 02 // UPPER SUITE`,jd.forEach(e=>{let t=parseInt(e.getAttribute(`data-target-screen`)),n=t===1&&r<=3||t===4&&(r===4||r===5)||t===6&&r===6;e.classList.toggle(`active`,n)}),kd.forEach((e,t)=>{e.classList.toggle(`active`,t+1===r)}),rf(r)}function tf(e){Vu&&uf(!1),Hu&&df(!1);let t=document.documentElement.scrollHeight-window.innerHeight,n=(e-1)/(zu.length-1)*t;window.scrollTo({top:n,behavior:`smooth`})}var nf=[];function rf(e){let t=zu[e-1];t&&(nf=t.hotspots||[],Md.innerHTML=``,nf.forEach(e=>{let t=document.createElement(`div`);t.className=`hotspot-marker`,t.id=`hotspot-${e.id}`,t.innerHTML=`
      <div class="hotspot-pin">
        <div class="hotspot-core"></div>
      </div>
      <div class="hotspot-label">${e.name}</div>
    `,t.addEventListener(`click`,t=>{t.stopPropagation(),of(e)}),Md.appendChild(t)}))}function af(){if(Vu||Hu){Md.style.display=`none`;return}Md.style.display=`block`;let e=new W;nf.forEach(t=>{let n=document.getElementById(`hotspot-${t.id}`);if(!n)return;if(e.copy(t.pos),e.project(Wu),e.z>1||e.x<-1.1||e.x>1.1||e.y<-1.1||e.y>1.1){n.style.opacity=`0`,n.style.pointerEvents=`none`;return}let r=(e.x*.5+.5)*window.innerWidth,i=(-e.y*.5+.5)*window.innerHeight;n.style.left=`${r}px`,n.style.top=`${i}px`,n.style.opacity=`1`,n.style.pointerEvents=`auto`})}function of(e){Fd.textContent=e.category,Id.textContent=e.name,Ld.textContent=e.desc,Rd.textContent=e.mat,zd.textContent=e.dim,Bd.textContent=e.origin,Nd.classList.remove(`hidden`),gd=0,_d=0,td.copy(e.pos);let t=new W().subVectors(Wu.position,e.pos).normalize().multiplyScalar(65);t.y=Math.max(t.y,16),ed.copy(e.pos).add(t),nd=42}function sf(){Nd.classList.add(`hidden`),ef()}function cf(e){document.querySelectorAll(`.swatch-btn[data-type="floor"]`).forEach(t=>{t.classList.toggle(`active`,t.getAttribute(`data-val`)===e)}),[`living`,`bedroom`].forEach(t=>{let n=Xu[t].floor;n&&(e===`oak`?(n.map=qd.floorOak,n.roughness=.32,n.clearcoat=.38,n.color.setHex(16777215)):e===`walnut`?(n.map=qd.walnut,n.roughness=.35,n.clearcoat=.45,n.color.setHex(14540253)):e===`marble`&&(n.map=qd.marble,n.roughness=.12,n.clearcoat=.9,n.color.setHex(16777215)),n.needsUpdate=!0)})}function lf(e){document.querySelectorAll(`.swatch-btn[data-type="fabric"]`).forEach(t=>{t.classList.toggle(`active`,t.getAttribute(`data-val`)===e)});let t={charcoal:3290428,greige:5919565,sand:9075561}[e]||3290428;Xu.living.cushion&&(Xu.living.cushion.color.setHex(t),Xu.living.cushion.needsUpdate=!0),Xu.bedroom.cushion&&(Xu.bedroom.cushion.color.setHex(t),Xu.bedroom.cushion.needsUpdate=!0),Xu.bedroom.bedDuvet&&(Xu.bedroom.bedDuvet.color.setHex(t),Xu.bedroom.bedDuvet.needsUpdate=!0)}function uf(e){Vu=typeof e==`boolean`?e:!Vu,Vu&&Hu&&df(!1),Vu?(document.body.classList.add(`orbit-mode`),Cd.textContent=`360° Active`,Ku.enabled=!0,Ku.target.copy(Qu)):(document.body.classList.remove(`orbit-mode`),Cd.textContent=`Scroll Tour`,Ku.enabled=!1,ef())}function df(e){Hu=typeof e==`boolean`?e:!Hu,Dd.classList.toggle(`active`,Hu),Od.textContent=Hu?`Touring...`:`Auto Tour`,Hu&&Vu&&uf(!1),Hu||ef()}function ff(){window.addEventListener(`scroll`,ef,{passive:!0}),window.addEventListener(`resize`,pf,!1),jd.forEach(e=>{e.addEventListener(`click`,()=>{tf(parseInt(e.getAttribute(`data-target-screen`)))})}),kd.forEach(e=>{e.addEventListener(`click`,()=>{tf(parseInt(e.getAttribute(`data-screen`)))})}),document.querySelectorAll(`.atmos-btn`).forEach(e=>{e.addEventListener(`click`,()=>{Xd(e.getAttribute(`data-atmos`))})}),Sd.addEventListener(`click`,()=>uf()),Dd.addEventListener(`click`,()=>df()),wd.addEventListener(`click`,()=>{gd=0,_d=0,tf(1)}),window.addEventListener(`pointerdown`,e=>{if(!Vu&&(e.pointerType!==`mouse`||e.button===0)&&!e.target.closest(`button, input, a, .swatch-btn, .hotspot-marker, .modal-box, .drawer-panel, .screen-navigator, .atmosphere-bar, .journey-pill`)){ud=!0,dd=e.pointerId,fd=e.clientX,pd=e.clientY,document.body.classList.add(`is-dragging`);try{e.target.setPointerCapture(e.pointerId)}catch{}e.cancelable&&e.preventDefault()}},{passive:!1}),window.addEventListener(`pointermove`,e=>{if(!ud||dd!==null&&e.pointerId!==dd)return;let t=e.clientX-fd,n=e.clientY-pd;fd=e.clientX,pd=e.clientY,gd+=t*.0035,_d-=n*.0035,_d=Math.max(-1.28,Math.min(1.28,_d)),e.cancelable&&e.preventDefault()},{passive:!1});let e=e=>{ud&&(dd!==null&&e.pointerId&&e.pointerId!==dd||(ud=!1,dd=null,document.body.classList.remove(`is-dragging`)))};window.addEventListener(`pointerup`,e),window.addEventListener(`pointercancel`,e),window.addEventListener(`blur`,e),window.addEventListener(`dblclick`,e=>{e.target.closest(`button, input, a, .swatch-btn, .hotspot-marker, .modal-box, .drawer-panel`)||(gd=0,_d=0)}),Td.addEventListener(`click`,()=>{document.body.classList.toggle(`hide-cards`);let e=document.body.classList.contains(`hide-cards`);Td.style.opacity=e?`0.5`:`1.0`}),Ed.addEventListener(`click`,()=>{Vd.classList.toggle(`hidden`),Ed.classList.toggle(`active`,!Vd.classList.contains(`hidden`))}),Hd.addEventListener(`click`,()=>{Vd.classList.add(`hidden`),Ed.classList.remove(`active`)}),document.querySelectorAll(`.swatch-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-type`),n=e.getAttribute(`data-val`);t===`floor`?cf(n):t===`fabric`&&lf(n)})}),Ud.addEventListener(`input`,e=>{let t=parseFloat(e.target.value);Wd.textContent=`${Math.round(t)}%`,Gu.toneMappingExposure=t/100}),Gd.addEventListener(`input`,e=>{let t=parseFloat(e.target.value);Kd.textContent=`${Math.round(t)}%`,Ju.strength=t/100*.8}),Pd.addEventListener(`click`,sf)}function pf(){Wu.aspect=window.innerWidth/window.innerHeight,Wu.updateProjectionMatrix(),Gu.setSize(window.innerWidth,window.innerHeight),Gu.setPixelRatio(Math.min(window.devicePixelRatio,2)),qu.setSize(window.innerWidth,window.innerHeight),ef()}function mf(){if(requestAnimationFrame(mf),Hu){Uu+=.005;let e=Bu===`living`?new W(65,45,100):new W(30,40,60),t=Bu===`living`?220:160;Wu.position.x=e.x+Math.cos(Uu)*t,Wu.position.z=e.z+Math.sin(Uu)*t,Wu.position.y=e.y+Math.sin(Uu*.5)*35,Wu.lookAt(e)}else if(Vu)Ku.update();else{Zu.lerp(ed,.08),Qu.lerp(td,.08),$u=Dt.lerp($u,nd,.08),md=Dt.lerp(md,gd,.12),hd=Dt.lerp(hd,_d,.12);let e=new W().subVectors(Qu,Zu).normalize(),t=Math.atan2(e.x,-e.z),n=Math.asin(Dt.clamp(e.y,-.96,.96)),r=t+md,i=Dt.clamp(n+hd,-1.35,1.35);bd?(vd=Dt.lerp(vd,r,.14),yd=Dt.lerp(yd,i,.14)):(vd=r,yd=i,bd=!0);let a=Math.cos(yd),o=Math.sin(vd)*a,s=Math.sin(yd),c=-Math.cos(vd)*a,l=new W(Zu.x+o*150,Zu.y+s*150,Zu.z+c*150);Wu.position.copy(Zu),Wu.lookAt(l),Math.abs(Wu.fov-$u)>.01&&(Wu.fov=$u,Wu.updateProjectionMatrix())}af(),qu.render()}Jd();